...
- **Des**: للجمع بنوعيه. مثال: **Des** pommes (تفاح)`,
    smartTip: 'نصيحة المساعد: لغة الفرنسية لا تتبع دائماً جنس الكلمات في اللغة العربية! تذكر أن الأداة الأساسية للتعريف للمذكر هي "Le" وللمؤنث "La". خطأ شائع هو تجاهل الإدغام (L\') قبل حروف العلة، تذكر أنها تلغي حرف العلة في الأداة لتسهيل النطق.',
    exercises: [
...
- (-age): Le courage (الشجاعة)`,
    smartTip: 'نصيحة المساعد: لا تنخدع بنهايات الكلمات! الكلمات التي تنتهي بـ "e" ليست دائماً مؤنثة. الطريقة الأضمن هي حفظ الاسم مع أداة التعريف الخاصة به (le/la) لتتذكر جنسه بسهولة.',
    exercises: [
...
3. الكلمات المنتهية بـ **-eau, -au, -eu** تُجمع بإضافة **x**:
   ...
   - un feu (نار) -> des feu**x** (نيران)`,
    smartTip: 'نصيحة المساعد: تذكر أن معظم قواعد الجمع تتعلق بنهاية الكلمة المفرد. للكلمات التي تنتهي بـ "-eau"، الجمع دائماً ينتهي بـ "-x". خطأ شائع هو إضافة "s" بدلاً من "x" لهذه الكلمات.',
    exercises: [
...
- Une voiture **rouge** (سيارة حمراء).`,
    smartTip: 'نصيحة المساعد: ترتيب الجملة الفرنسية (فاعل-فعل-مفعول به) مشابه للعربية، ولكن الصفات تختلف! تذكر دائماً أن تضع الصفة بعد الاسم، وخطأ شائع جداً هو نسيان مطابقة الصفة (تأنيثها أو جمعها) إذا كان الاسم مؤنثاً أو جمعاً.',
    exercises: [
  ...
  },
  {
    ...
    **القاعدة الأساسية لاسم المفعول:**
    ...
    smartTip: 'نصيحة المساعد: أهم نقطة هنا هي اختيار الفعل المساعد! معظم الأفعال تُستخدم مع "avoir"، ولكن أفعال الحركة والتحول (مثل aller, venir) تتطلب "être". إذا استخدمت "être"، لا تنسَ مطابقة اسم المفعول مع الفاعل (إضافة "e" للمؤنث و "s" للجمع)!',
    exercises: [
